...
<nav class="navbar navbar-expand-lg bg-primary" style="border-bottom: 5px solid #ff8838;">
    <div class="container-fluid">
        <a class="navbar-brand text-white fw-bold ms-5" href="?page=home">
            <h1 class="mb-0"><i class="bi bi-robot text-black"></i><b>&nbsp; CHATAI</b></h1>
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarScroll">
            <ul class="navbar-nav me-3 my-2 my-lg-0 navbar-nav-scroll">
                ...
                <?php else : ?>
                <!-- Login Button -->
        <a href="?page=login" class="btn btn-warning fw-bolder" style="border-radius: 20px;">Login <i class="bi bi-box-arrow-in-right "></i></a>
                <?php endif; ?>
            </ul>
        </div>
    </div>
